...
//        // Logic bổ sung của bạn
//        String customErrorMessage = "Custom message: Invalid JSON format.";
//        Map<String, Object> responseBody = new LinkedHashMap<>();
//        responseBody.put("defaultResponse", originalResponse.getBody());
//        responseBody.put("customMessage", customErrorMessage);
//
//        // Trả về ResponseEntity kết hợp
