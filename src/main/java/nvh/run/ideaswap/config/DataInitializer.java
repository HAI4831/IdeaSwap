...
//        User user = userService.createUser(RegisterRequest.builder()
//                .build());
...
//        );
        ...
        //        DocumentRepository docmentRepository = applicationContext.getBean(DocumentRepository.class);
//        String filePath = "testDoc.pdf";
//        createPdf(filePath);
//        GoogleDriveService googleDriveService = applicationContext.getBean(GoogleDriveService.class);
//        String fileUrl = googleDriveService.uploadFile(new File(filePath));
//        String fileUrl =googleDriveService.uploadFile();
//        Document document = docmentRepository.save(
//                Document.builder()
...
//            Document document = new com.itextpdf.text.Document(pdf);
