...
public class VideoController {
    ...
    public ResponseEntity<Object> findAll() {
        return ResponseEntity.status(200).body(
                Map.of(
                        "success", true,
                        "message", "Retrieve List videos successfully",
    ...
    public ResponseEntity<Object> findById(@PathVariable String id) {
        return ResponseEntity.status(200).body(
                Map.of(
                        "success", true,
                        "message", "Retrieve video by Id successfully",
    ...
    @PutMapping("/update/view/{videoId}")
    public ResponseEntity<Object> updateView(@PathVariable String videoId, @RequestBody UpdateViewVideoRequest updateViewVideoRequest){
        return ResponseEntity.status(200).body(
                Map.of(
                        "success", true,
                        "message", "Update Video successfully",
                        "video", videoService.updateView(videoId,updateViewVideoRequest))
        );
    }
