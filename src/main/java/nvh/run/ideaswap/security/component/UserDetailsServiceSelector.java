...
import nvh.run.ideaswap.security.service.ManagerDetailsServiceImpl;
import nvh.run.ideaswap.security.service.UserDetailsServiceImpl;
...
//                ||requestURI.startsWith("/api/v1/user")
                ||requestURI.startsWith("/api/v1/auth/admin")
